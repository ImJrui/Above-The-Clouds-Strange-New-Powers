...
return {
	DESCRIBE = {
		SEEDOFRUIN = en_zh({EN = "Wolfgang does not like spooky seed.", CN = "沃尔夫冈不喜欢幽灵般的种子"}),
		SKYWORTHY = en_zh({EN = "Is fun flying machines.", CN = "有趣的飞行机器"}),
		SKYWORTHY_KIT = en_zh({EN = "Is fun flying machines.", CN = "有趣的飞行机器"}),
		SLINGSHOTAMMO_SHADOW = en_zh({EN = 'Is little bits of junk', CN = "是一些小垃圾"}),
		SLINGSHOTAMMO_INFUSED = en_zh({EN = 'Is little bits of junk', CN = "是一些小垃圾"}),
		SLINGSHOTAMMO_ALLOY = en_zh({EN = 'Is little bits of junk', CN = "是一些小垃圾"}),
		FROGFISHBOWL_HAMLET = en_zh({EN = "Food will make Wolfgang very strong!", CN = "食物会让沃尔夫冈变得非常强壮!"}),
		ALOE_OVERSIZED = en_zh({EN = "Wolfgang eat everything.", CN = "沃尔夫冈什么都吃"}),
		RADISH_OVERSIZED = en_zh({EN = "Is spicy.", CN = "辣的"}),
		SHOPLOCKER = en_zh({EN = "Wolfgang wants more of that item, please.", CN = "沃尔夫冈要更多"}),
		DUMBBELL_IRON = en_zh({EN = "Is Iron! Like Wolfgang's Muscles.", CN = "是钢铁！ 象沃尔夫冈的肌肉！"})
	},
}
--[[

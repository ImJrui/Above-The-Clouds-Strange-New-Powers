...
return {
	DESCRIBE = {
		SEEDOFRUIN = _Translator({EN = "This seed makes me want to do a fiery step-dance!", CN = "这颗种子让我想跳一段火热的踢踏舞!"}),
		SKYWORTHY = _Translator({EN = "I should step out of here.", CN = "我应该离开这里"}),
		SKYWORTHY_KIT = _Translator({EN = "I should step out of here.", CN = "我应该离开这里"}),
		SLINGSHOTAMMO_SHADOW = _Translator({EN = 'Ever considered making your ammo a little more flammable?', CN = "有没有考虑过让你的弹药更易燃一点"}),
		SLINGSHOTAMMO_INFUSED = _Translator({EN = 'Ever considered making your ammo a little more flammable?', CN = "有没有考虑过让你的弹药更易燃一点"}),
		SLINGSHOTAMMO_ALLOY = _Translator({EN = 'Ever considered making your ammo a little more flammable?', CN = "有没有考虑过让你的弹药更易燃一点"}),
		FROGFISHBOWL_HAMLET = _Translator({EN = "Woah, that's a ton of frogs.", CN = "哇，好多青蛙啊"}),
		ALOE_OVERSIZED = _Translator({EN = "Gross. It's all gooey inside.", CN = "恶心,里面都是黏糊糊的"}),
		RADISH_OVERSIZED = _Translator({EN = "Like little balls of fire.", CN = "就像小火球"}),
		SHOPLOCKER = _Translator({EN = "I need more of these! To step! Hurry up and stock more, you jerk!", CN = "再多来点！赶紧！快补库存，你这蠢货！"}),
	},
}
--[[

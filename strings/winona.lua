...
return {
	DESCRIBE = {
		SEEDOFRUIN = _Translator({EN = "Those eggheads ought to take a crack at it.", CN = "那些书呆子应该试一试."}),
		SKYWORTHY = _Translator({EN = "The bossman would love this...", CN = "老板会喜欢这个的……"}),
		SKYWORTHY_KIT = _Translator({EN = "The bossman would love this...", CN = "老板会喜欢这个的……"}),
		SLINGSHOTAMMO_SHADOW = _Translator({EN = 'Hem. Handmade, irregular shapes.', CN = "哼哼.手工制作的,形状都是不规则的."}),
		SLINGSHOTAMMO_INFUSED = _Translator({EN = 'Hem. Handmade, irregular shapes.', CN = "哼哼.手工制作的,形状都是不规则的."}),
		SLINGSHOTAMMO_ALLOY = _Translator({EN = 'Hem. Handmade, irregular shapes.', CN = "哼哼.手工制作的,形状都是不规则的."}),
		FROGFISHBOWL_HAMLET = _Translator({EN = "Mmm! Love Warly's dishes.", CN = "嗯!我喜欢沃利的菜"}),
		ALOE_OVERSIZED = _Translator({EN = "Aloe's good for everything.", CN = "芦荟对什么都有好处"}),
		RADISH_OVERSIZED = _Translator({EN = "Radish-ical!", CN = "萝卜"}),
		SHOPLOCKER = _Translator({EN = "Those swine betta' be more efficient at givin' me what I want!", CN = "这群蠢货最好识相点！赶紧满足我的要求，否则有你们好看！"}),
		DUMBBELL_IRON = _Translator({EN = "Awful fancy for something you just pick up and put down over and over.", CN = "就是个反复拿起和放下的东西，弄这么花哨干啥。"})
	},
}
--[[

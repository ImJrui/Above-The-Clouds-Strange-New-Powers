...
configuration_options={ --模组变量配置
	{
		name = "rate_pugalisk_health",--modmain脚本里调用变量
    ...
    {
		name = "rate_ancient_herald_health",--modmain脚本里调用变量
		hover = translate({en = "Increase boss HP to get more loot", zh = "提高boss血量将获得更多战利品"}),
	...
	{
		name = "rate_antqueen_health",--modmain脚本里调用变量
		hover = translate({en = "Increase boss HP to get more loot", zh = "提高boss血量将获得更多战利品"}),
    ...
    {
		name = "rate_ancient_hulk_health",--modmain脚本里调用变量
		hover = translate({en = "Increase boss HP to get more loot", zh = "提高boss血量将获得更多战利品"}),
	...
	{
		name = "EnableSkilltree",--modmain脚本里调用变量
	...
	{
		name = "TouchStone",--modmain脚本里调用变量
	...
	{
		name = "Critterlab",--modmain脚本里调用变量
	...
	{
		name = "EnableSkyworthy",--modmain脚本里调用变量
